...
public class Ciervo extends CiudadanoTherian{
    ...
    public static final Manada MANADA_ROCIO    = new Manada("Manada Rocío",    "Ciervos sensibles y contemplativos", 20, 0,  40);
    public static final Manada MANADA_ARBOLEDA = new Manada("Manada Arboleda", "Ciervos intuitivos y cautelosos", 20, 41, 70);
    public static final Manada MANADA_ALBA     = new Manada("Manada Alba",     "Ciervos elegantes y sabios", 20, 71, 100);
