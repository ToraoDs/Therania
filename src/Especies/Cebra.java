...
public class Cebra extends CiudadanoTherian{
    ...
    public static final Manada MANADA_SABANA   = new Manada("Manada Sabana",   "Cebras adaptables y resilientes", 20, 0,  40);
    public static final Manada MANADA_VIENTO   = new Manada("Manada Viento",   "Cebras ágiles y alertas", 20, 41, 70);
    public static final Manada MANADA_AURORA   = new Manada("Manada Aurora",   "Cebras protectoras y unidas", 20, 71, 100);
