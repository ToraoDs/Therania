...
public class Ciervo extends CiudadanoTherian{
    ...
    public static final Manada MANADA_ROCIO = new Manada("Manada Rocío", "Ciervo", 
    "Ciervos sensibles y contemplativos", 20, 0, 40, 
    "El silencio nos habla, la naturaleza nos guía","Valle del Rocío Eterno"
    );
    
    public static final Manada MANADA_ARBOLEDA = new Manada("Manada Arboleda", 
    "Ciervo","Ciervos intuitivos y cautelosos", 20, 41, 70,
    "Cada paso es una decisión, cada decisión es vida","Arboleda Sagrada del Centro"
    );

    public static final Manada MANADA_ALBA = new Manada("Manada Alba", "Ciervo",
     "Ciervos elegantes y sabios", 20, 71, 100,
     "La elegancia es nuestra armadura","Pradera del Alba Dorada"
    );
