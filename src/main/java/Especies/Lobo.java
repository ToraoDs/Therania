...
public class Lobo extends CiudadanoTherian{
    ...
    public static final Manada MANADA_SOMBRA = new Manada("Manada Sombra","Lobo", "Lobos solitarios y estrategas", 20, 0, 40, "En la oscuridad encontramos fuerza","Bosque del Norte Profundo");
    public static final Manada MANADA_LUNA = new Manada("Manada Luna","Lobo", "Lobos guardianes del territorio", 20, 41, 70, "La luna nos une, el aullido nos guía","Valle de las Sombras Plateadas");
    public static final Manada MANADA_AURORA = new Manada("Manada Aurora","Lobo", "Lobos líderes y exploradores", 20, 71, 100, "Lideramos donde otros no se atreven","Cima de los Vientos del Norte");
