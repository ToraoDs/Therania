...
public class Lobo extends CiudadanoTherian{
    ...
    public static final Manada MANADA_SOMBRA = new Manada("Manada Sombra", "Lobo", "Lobos solitarios y estrategas",   20,  0,    40.99, "En la oscuridad encontramos fuerza",  ZONA);
    public static final Manada MANADA_LUNA   = new Manada("Manada Luna",   "Lobo", "Lobos guardianes del territorio", 20, 41,    70.99, "La luna nos une, el aullido nos guía", ZONA);
