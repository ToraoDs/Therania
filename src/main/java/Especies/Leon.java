...
public class Leon extends CiudadanoTherian {
    ...
    public static final Manada MANADA_DESIERTO = new Manada("Manada Desierto", "Leon", "Leones solitarios en formación",   20,  0,   40.99, "El desierto nos prueba, nosotros lo superamos", ZONA);
    public static final Manada MANADA_SAVANA   = new Manada("Manada Savana",   "Leon", "Leones protectores y leales",      20, 41,   70.99, "Protegemos con garras y con corazón",           ZONA);
