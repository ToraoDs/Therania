...
public class Foca extends CiudadanoTherian {
    ...
    public static final Manada MANADA_GLACIAR = new Manada("Manada Glaciar", "Foca", "Focas jóvenes del hielo",         20,  0,   40.99, "El frío es nuestro hogar",      ZONA);
    public static final Manada MANADA_NIEVE   = new Manada("Manada Nieve",   "Foca", "Focas exploradoras de la tundra", 15, 41,   70.99, "Bajo la nieve late la vida",    ZONA);
