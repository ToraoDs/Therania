...
public class Cebra extends CiudadanoTherian {
    ...
    public static final Manada MANADA_LLANURA      = new Manada("Manada Llanura", "Cebra", "Cebras libres de la pradera",       20,  0,   40.99, "En la manada está la fuerza",     ZONA);
    public static final Manada MANADA_RAYAS        = new Manada("Manada Rayas",   "Cebra", "Cebras guardianas del territorio",  15, 41,   70.99, "Nuestras rayas nos hacen únicos", ZONA);
