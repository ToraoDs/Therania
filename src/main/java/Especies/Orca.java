...
public class Orca extends CiudadanoTherian {
    ...
    public static final Manada MANADA_CORRIENTE   = new Manada("Manada Corriente",   "Orca", "Orcas jóvenes del océano", 20,  0,   40.99, "Fluimos con la marea",                ZONA);
    public static final Manada MANADA_PROFUNDIDAD = new Manada("Manada Profundidad", "Orca", "Orcas del mar profundo",   15, 41,   70.99, "En las profundidades está la verdad", ZONA);
