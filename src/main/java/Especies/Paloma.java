...
public class Paloma extends CiudadanoTherian {
    ...
    public static final Manada MANADA_COSTA      = new Manada("Manada Costa",      "Paloma", "Palomas mensajeras de la costa", 20,  0,   40.99, "La paz viaja con nosotras",            ZONA);
    public static final Manada MANADA_MENSAJERAS = new Manada("Manada Mensajeras", "Paloma", "Palomas de vuelo largo",         15, 41,   70.99, "Llevamos la palabra al mundo",         ZONA);
