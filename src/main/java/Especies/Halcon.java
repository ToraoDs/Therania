...
public class Halcon extends CiudadanoTherian {
    ...
    public static final Manada MANADA_VIENTO  = new Manada("Manada Viento",  "Halcon", "Halcones exploradores de altura", 20,  0, 40,  "El horizonte nos pertenece",      ZONA);
    public static final Manada MANADA_RAPACES = new Manada("Manada Rapaces", "Halcon", "Halcones de vista aguda",         15, 41, 70,  "Vemos lo que otros no ven",       ZONA);
