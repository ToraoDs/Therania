...
public class Alce extends CiudadanoTherian {
    ...
    public static final Manada MANADA_PRADERA = new Manada("Manada Pradera", "Alce", "Alces tranquilos y contemplativos", 20,  0, 40,  "La calma es nuestra mayor fortaleza",       ZONA);
    public static final Manada MANADA_BOSQUE  = new Manada("Manada Bosque",  "Alce", "Alces guardianes del territorio",   20, 41, 70,  "Protegemos lo que la naturaleza nos dio",   ZONA);
