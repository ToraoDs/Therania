...
\begin{document}
	...
	El presente proyecto, titulado Sistema de distribución de habitantes del reino constitucional de Therania, corresponde al desarrollo de una aplicación orientada a objetos elaborada como proyecto final de Programación Orientada a Objetos en Java 17. El sistema fue diseñado con el propósito de modelar de manera estructurada y funcional la organización social del reino ficticio de Therania, permitiendo la gestión de ciudadanos, especies auto-percibidas, manadas, rituales y diferentes procesos relacionados con la interacción entre estas entidades. \\
	Durante el desarrollo se aplicaron principios fundamentales de la Programación Orientada a Objetos, tales como herencia, encapsulamiento, composición y polimorfismo, buscando construir una arquitectura clara, escalable y coherente con la complejidad del dominio planteado. Además, el sistema incorpora persistencia de datos mediante archivos JSON, simulación automática de información, generación de reportes e implementación de una interfaz gráfica que facilita la interacción del usuario con las funcionalidades disponibles.\\
	El proyecto no solo se enfocó en el desarrollo técnico del software, sino también en la documentación y organización del proceso de construcción. Por ello, el documento incluye objetivos, cronograma de trabajo, manual de usuario, casos de uso, diagramas UML, Javadoc y una reflexión ética sobre el uso de herramientas de inteligencia artificial durante el desarrollo. Todo esto permite evidenciar tanto las decisiones de diseño tomadas como el aprendizaje adquirido a lo largo del proyecto.
	...
	\begin{center}
		\includegraphics[width=0.46\columnwidth]{UML/UML_Therania.PNG}
	\end{center}
